...
public enum Dialog {
	 ...
	 * Stage 1's dialog
	 */
	DIALOG_STAGE1(new String [] {"Bonjour jeune graine.", "Je suis Sativa, gardien de cette tour et protecteur de son tr�sor.", "Aujourd�hui, je vais te guider � travers ton dangereux p�riple.", "Pour commencer, entre ton nom."}),
	 ...
	 * Stage 8's dialog
	 */
	DIALOG_STAGE8(new String[] {"Bien bien.", "Parfois on dit qu'il faut savoir tout recommencer pour mieux repartir.", "Retourne donc au d�but de la tour et cette fois-ci, n'échoue pas ! "}),
