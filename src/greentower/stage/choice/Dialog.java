...
public enum Dialog {
	 ...
	 * Stage 1's dialog
	 */
	DIALOG_STAGE1(new String [] {"Bonjour jeune graine.", "Je suis Sativa, gardien de cette tour et protecteur de son trésor.", "Aujourd'hui, je vais te guider à travers ton dangereux périple.", "Appuie sur '0' et ensuite 'Entrée' pour continer"}),
	 ...
	 * Stage 6's dialog
	 */
	DIALOG_STAGE6(new String[] {"Serais-tu l'élu ?", "Alliant intelligence et chance afin de vaincre les forces du mal ?", "Je me dois de vérifier.", "Réponds à cette énigme !", "Combien y a-t-il de carrés en tout, dans une grille 4x4 ?",
			"\n",
			"+---+---+---+---+",
			"|   |   |   |   |",
			"+---+---+---+---+",
	 ...
	 * Stage 7's dialog
	 */
	DIALOG_STAGE7(new String[] {"Tu manques de chance et je ne peux te blamer.", "Tu n'es certes pas l'élu mais cela ne t'empèchera pas de pouvoir monter au sommet.", "Le chemin sera juste plus difficile.", "En parlant de difficulté, connais-tu le rush hour ? Viens donc faire une partie !"}), // PARTIE RUSH HOUR
	 ...
	 * Stage 22's dialog
	 */
	DIALOG_STAGE22(new String[] {"Une porte bloque le chemin.", "C'est un étage de croisement.", "Qu'importe les chemins que tu as empruntés, si tu as fait preuve de suffisamment de volonté, tous mènent à cet étage.", "La porte restera verrouillée tant que nous n'aurons pas trouvé le code à 4 couleurs qui change règulièrement."}), // PARTIE DE MASTERMIND
